---
layout: default
title: <Labhya Mehta> - Curriculum Vitae
permalink: /cv/
---
## Curriculum Vitae

[Download my CV]({{ "/assets/pdf/CV.pdf" | relative_url }}) in PDF format.


**Email:** [lm946@cornell.edu](mailto:lm946@cornell.edu) 

---

#### Objective
Aspiring engineering student with a strong foundation in aerospace design. Passionate about space travel and engineering, and eager to apply my knowledge in real-world applications.
...
- **Programming:** Python, MATLAB, MySQL, OCaml  
- **Tools:** 3D Printing, Laser Cutting, Mill and Lathe Operations  

---

#### Projects
- **CUAir eVTOL Tail Design**:  
  *Structural design and analysis of inverted V-tail for a student-built eVTOL UAV.*  
  - Led structural design including spars, spar caps, ribs, and skin; translated flight loads from XFLR5 into internal load paths.  
  - Performed stress and deflection analysis in ANSYS; iterated geometry and layups to meet stiffness and strength requirements.  
  - Modeled components in SolidWorks and fabricated ribs and supports using laser cutting and FDM 3D printing.  

- **CUAir Aerodynamic Boom Caps & Pitot Tube Mounts**:  
  *Improved aerodynamic profiling and structural packaging for avionics sensors on eVTOL aircraft.*  
  - Designed boom caps and pitot mounts to optimize airflow and integrate avionics sensors.  
  - Ensured structural integrity while maintaining minimal weight and streamlined aerodynamics.  
...
- **Cornell University Unmanned Air Systems (CUAir) - Airframe Engineer**  
  ...
  - Designed aerodynamic boom caps and pitot tube mounts to improve aerodynamic profiling and structural packaging for avionics sensors.  
