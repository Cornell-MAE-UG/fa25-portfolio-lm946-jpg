...
<div class="accordion-section">
  <div class="accordion-header">1. Client Pitch</div>
...
<div class="accordion-section">
  <div class="accordion-header">2. Functional Prototype</div>
  <div class="accordion-content">

  ## Functional Prototype

  ### Purpose
  The objective of the functional prototype was to evaluate the feasibility of mechanically and pneumatically separating SLF from grape clusters under controlled conditions. The prototype focused on validating whether airflow and agitation could effectively displace SLF without damaging grapes.

  ### What Was Tested
  - Effectiveness of brush-induced agitation in exposing SLF  
  - Response of SLF to varying air velocities  
  - Selectivity of pneumatic removal relative to grape mass  
  - Interaction between airflow and clustered grape geometry  

  ### Prototype Design
  The prototype consisted of a scaled conveyor section with a rotary brush and a compressed air delivery system. Adjustable airflow allowed testing across a range of velocities to determine optimal separation conditions.

  ### Results & Outcomes
  - Airflow successfully displaced SLF analogs at targeted velocity ranges  
  - Minimal movement of grape analogs confirmed selective force application  
  - Brush mechanism improved exposure but introduced variability in positioning  
  - System performance depended strongly on material distribution and flow consistency  

  ### Key Takeaways
  - Pneumatic separation is viable when tuned to mass differences  
  - Pre-conditioning (via brushing) is critical for consistent removal  
  - Flow uniformity is a major factor in real-world implementation  

  ### Next Steps
  - Refine airflow delivery geometry  
  - Improve brush design for consistency  
  - Integrate continuous flow testing conditions  
